    ...
    <Page>
      <div className="flex-grow justify-center items-center flex flex-col text-white">
        <div className="sm:text-center">
          ...
          <p className="mb-4">If you wish, you may connect with us through:</p>
          <ul className="list-none list-inside [&>*]:mb-2 text-left">
            ...
            <li>
              ...
              <Link href="tel:+6349440067" className="normal-link">
                (049) 544 0067
              </Link>
            </li>
            <li className="mb-2">
              ...
              <Link
                ...
                className="normal-link"
              >
                DepEd Tayo Santa Rosa Science and Technology HS - Santa Rosa
                City
              </Link>
            </li>
          </ul>
