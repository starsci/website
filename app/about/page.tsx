      ...
      <div className="container py-8 flex-1">
        ...
        <div className="block lg:grid auto-cols-auto items-center gap-x-8 gap-y-4">
          ...
          <p className="col-start-2 mb-4 lg:mb-0">
            ...
            leaders of our nation produced by highly motivated and committed
            21st century professional teachers and school personnel who are
            spurring growth in character and intelligence through the generous
            support of dynamic, dedicated, goal-driven, value-oriented external
            stakeholders.
          </p>
          ...
          <ul className="col-start-2 mb-4 lg:mb-0 list-disc list-inside">
            ...
            <li>
              To give proper time and devotion to studies and achieve the
