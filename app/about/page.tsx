        ...
        <Page>
            <div className="container py-8 flex-1">
                ...
                <p>President Gloria Macapagal-Arroyo signed into
                    ...
                    Technology High School on April 8, 2001. Cong. Uliran T.
                    Joaquin
                    of the 1st District of Laguna was its principal author. The
                    school started in School Year 2002-2003 through the
                    initiative
                    and financial support of the local government of Santa Rosa
                    led
                ...
                <div
                    className="block lg:grid auto-cols-auto items-center gap-x-8 gap-y-4">
                    <h2 className="text-left lg:text-center text-2xl font-semibold mb-2 col-span-2">Mission,
                    ...
                    <p className="col-start-2 mb-4 lg:mb-0">Through the
                        ...
                        state-of-the-art,
                        green school responsive to the science and technology
                        educational needs of the society towards a Maka-Diyos,
                        Makatao,
                    ...
                    <h2 className="text-left lg:text-center text-2xl font-semibold mb-2 col-span-2">DepEd
                    ...
                    <div className="col-start-2 mb-4 lg:mb-0">
                        ...
                        <ul className="mb-2 list-disc list-inside">
                            ...
                            <li>Evidenced-based policies, standards and
                                programs
                            </li>
                            <li>Responsive and relevant curricula</li>
                            <li>Highly competent and committed officials, and
                                teaching and
                        ...
                        <p>
                            ...
                            and
                            regulatory requirements, and sustains client
                            satisfaction
                    ...
                    <h3 className="text-xl font-semibold mb-2">Duties and
                        Responsibilities</h3>
                    <ul className="col-start-2 mb-4 lg:mb-0 list-disc list-inside">
